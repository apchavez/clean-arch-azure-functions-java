...
/**
 * Port for the append-only event log. Each state transition produces one immutable AppointmentEvent
 * document. Implemented by a Cosmos DB adapter targeting the appointment-events container.
 */
