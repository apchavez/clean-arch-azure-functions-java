...
public final class JwtValidator {
  ...
  private static byte[] hmacSha256(String data, String secret) {
    try {
      ...
      // IllegalArgumentException covers e.g. SecretKeySpec rejecting a zero-length secret
      // ("Empty key") -- without this, a blank/empty secret passed directly to verify() (bypassing
      // AuthGuard's own blank-secret guard) would leak a raw crypto exception instead of the
      // consistent IllegalStateException this method otherwise guarantees for HMAC failures.
