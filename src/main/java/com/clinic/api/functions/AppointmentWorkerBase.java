...
/**
 * Shared processing logic for country-specific Service Bus workers. Each country worker (PE, CL)
 * extends this class and provides its country code so routing is handled here once rather than
 * duplicated in each subclass.
 */
