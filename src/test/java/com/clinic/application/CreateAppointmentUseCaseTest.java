...
/**
 * Unit test for the create use case using in-memory fakes for the ports. No Azure needed — this is
 * the payoff of Clean Architecture: the business logic is testable in isolation. Equivalent to the
 * Jest unit tests in AWS.
 */
