...
class ProcessAppointmentUseCaseTest {
  ...
  void processesPendingAppointmentToCompletion() {
    ...
    new ProcessAppointmentUseCase(state, relational, publisher, notifier, eventStore)
        .execute("appt-1");
  ...
  void isIdempotentWhenAlreadyCompleted() {
    ...
    new ProcessAppointmentUseCase(
            state, relational, publisher, new CapturingNotifier(), new InMemoryEventStore())
        .execute("appt-2");
